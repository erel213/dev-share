...
func ReturnNotFound(message string) *pkgerrors.Error {
...
func ReturnBadRequest(message string) *pkgerrors.Error {
...
func ReturnConflict(message string) *pkgerrors.Error {
...
func ReturnUnauthorized(message string) *pkgerrors.Error {
...
func ReturnForbidden(message string) *pkgerrors.Error {
